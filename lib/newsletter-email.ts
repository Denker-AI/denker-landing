...
<body style="margin:0;padding:0;background-color:#f3f8f3;width:100%;">
  <table width="100%" cellpadding="0" cellspacing="0" role="presentation" style="width:100%;min-width:100%;background-color:#f3f8f3;background-image:radial-gradient(circle at 18% 0%, rgba(58,248,140,0.22), transparent 34%),radial-gradient(circle at 85% 18%, rgba(255,255,255,0.92), transparent 34%),linear-gradient(180deg, #ddf8e5 0%, #f7faf5 52%, #eff6ef 100%);">
