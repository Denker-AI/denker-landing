  ...
  theme: {
    extend: {
      ...
      boxShadow: {
        ...
        "glow-accent": "0 3px 12px rgba(58,248,140,0.25), 0 0 2px 1px rgba(58,248,140,0.12)",
        "glow-accent-sm": "0 2px 6px rgba(58,248,140,0.18)",
        "card-modal": "0 10px 40px -6px rgba(0,0,0,0.4), 0 2px 4px rgba(0,0,0,0.15)",
        "input-focus": "0 2px 10px rgba(58,248,140,0.15), 0 0 2px 1px rgba(58,248,140,0.08)",
      },
      borderRadius: {
        glass: "12px",
        frame: "10px",
